...
- Use exact text as oldText, include surrounding blank lines for unique match
- Batch changes to the same file into one edit_file call
- For deletions: section header + all bullets as oldText, newText empty
...
- Reference specific tools the agent has access to (read_file, write_file, edit_file, web_search, etc.)
